...
const init_phones = [],                      // Optional. Which graphs to display on initial load. Note: Share URLs will override this set
      ...
      page_title = "dc 헤마갤 이어폰 DB by ER4SR",   // Optional. Appended to the page title if share URLs are enabled
...
function watermark(svg) {
    ...
    if ( watermark_image_url ) {
        wm.append("image")
            .attrs({x:0, y:0, width:256, height:256, "xlink:href":watermark_image_url});
    }
